 ...
 */
@WebServlet(urlPatterns = {"/store_view"})
public class StoreController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		List<Product> listAllProduct = ProductDB.getAllProducts();
        ...
        List<Product> listProductByIndexPage = ProductDB.getProductByIndexPage(indexPage);
