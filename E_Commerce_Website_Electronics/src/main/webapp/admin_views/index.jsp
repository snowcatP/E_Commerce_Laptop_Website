...
<!-- DASHBOARD -->
  <main id="main" class="main">
    <div class="pagetitle">
      ...
      <% if(admin_acc != null){ %>
      	<h2 style="color:red">Xin chào <%= admin_acc.getAdmin().getFirstName() %> <%= admin_acc.getAdmin().getLastName() %></h2>
      <%} %> --%>
      
      <c:set var="admin_acc" value="${sessionScope.admin_acc }"/>
      <c:if test="${admin_acc != null }">
      	<h2 style="color:red">Xin chào <c:out value="${admin_acc.admin.firstName }"/> <c:out value="${admin_acc.admin.lastName }"/></h2>
